...
const CACHE=CACHE_PREFIX+'v3.0.188-20260802';
const ASSETS=['./','./index.html','./infection-classification-guide.html','./infectionDiseaseData.js?v=3.0.188','./taisaku-youten.html','./dictionaryPage.js?v=3.0.188','./style.css?v=3.0.188','./manifest.webmanifest','./glossaryData.js?v=3.0.188','./glossaryQuizData.js?v=3.0.188','./cultureManagementData.js?v=3.0.188','./comprehensiveSupplementData.js?v=3.0.188','./glossaryApp.js?v=3.0.188','./apple-touch-icon.png','./icon-192.png','./icon-512.png','./favicon-32.png'];
