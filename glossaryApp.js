...
const APP_VERSION='3.0.139',STORAGE_KEY='riyoshi_glossary_learning_v1',TODAY_BOOKMARK_KEY='riyoshi_glossary_today_bookmarks_v1',TEXT_SCALE_KEY='riyoshi_glossary_text_enlarged_v1',TODAY_META_KEY='__today10',ROUND_META_KEY='__roundProgress',CATEGORY_ROUND_KEY='__categoryRounds',REVIEW_DATE='2026-07-17';
...
function quizProgressSummary(){const s=quizHomeStats(),pct=s.total?Math.round(s.learned/s.total*100):0;return `<section class="summary-card quiz-progress-card"><div class="quiz-round-count">${lapLabel(roundNumber())}</div><div class="ring" style="--progress:${pct}%"><span>${pct}%</span></div><div><div class="summary-label">学習進捗</div><div class="summary-main">${s.learned} / ${s.total}語</div><div class="summary-sub">学習済み ${s.learned}語　未学習 ${s.unlearned}語<br>確認問題正答率 ${s.answered?s.rate+'％':'未解答'}</div></div><div class="progress-line quiz-progress-line"><i style="width:${pct}%"></i></div></section>`}
